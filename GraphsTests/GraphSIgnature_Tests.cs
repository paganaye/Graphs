...
public class GraphSignatureTests
{
   ...
   public void graph_with_two_nodes_and_one_edge()
   {
      ...
      var signature = new GraphSignature(graph);
      Assert.That(signature.ToString(),Is.EqualTo("[[1],[1]]"));
   }
   ...
   public void graph_with_multiple_edges()
   {
      ...
      Assert.That(signature.ToString(), Is.EqualTo("[3,1,[3,1],[[-1,[-1,-2,[-3,[-4]]]],[-1,[-1,-2],[-2,[-3]]]],[[-1,[-1,-2,[-3,[-4]]]],[-1,[-1,-2],[-2,[-3]]]]]"));
   }
